    ...
    >
      ...
      <div className="relative p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-light text-white mb-6">Login in to Artfolio</h1>
        ...
        <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex items-start gap-3 mt-2">
            ...
            <label htmlFor="terms" className="text-sm text-gray-300 leading-tight">
              I agree to the <span className="">Terms and Service</span> and <span className="">Privacy Policy</span>
            </label>
            <h1 className="text-white text-sm">Don't have an account <span className="text-cyan-400/60 underline"><Link href={'/auth/signup'}>Signup</Link></span></h1>
          </div>
