...
const Features = () => {
  const features = [
    ...
    {
      title: "Collaboration",
      description: "Work together with other artists and co-create stunning projects.",
      icon: <FaUsers size={35} color="#67E8F9" />,
    },
    {
      title: "Customization",
    ...
    },
    {
      ...
      description: "Your work is safe with advanced privacy controls and secure storage.",
